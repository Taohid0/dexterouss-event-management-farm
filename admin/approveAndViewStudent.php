        ...
        <?php
                    if(isset($_GET['delpostid'])){
                         ...
                         if(isset($_GET['approveid'])){
                            ...
                            $query="UPDATE pending_student_application
                                SET
                                Check1=1
                                Where StudentId='$postid'";
                                $update_rows = $db->update($query);
                                if ($update_rows) {
                                    echo "<span class='success'>Student Approved Successfully.    </span>";
                                    echo"<script>window.location = 'application_list.php';</script>";
                                } else {
                                    echo "<span class='error'>Student Not Approved Updated !</span>";
                                }
                         }
                 ?>
        <div class="grid_10">
                 ...
                 <?php
                    ...
                    <table class="form">
                        ...
                        <td></td>
                            ...
                            <td>
                                <a  href="application_list.php">OK</a>
                            </td>
                            <td>
                               <a onclick="return confirm('Are you Sure to Approve!');" href="?approveid=<?php echo $postresult['StudentId'];?>">Approve</a>
